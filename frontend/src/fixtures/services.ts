...
export const servicesColums: IColumns[] = [
  { title: 'Creation time', field: 'creationTime', type: 'date', dateSetting: { format: 'dd/MM/yyy HH:mm:ss' }, editable: 'never', initialEditValue: '',  tooltip: 'Date that api service was added' },
